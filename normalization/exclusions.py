...
OUTDIR = os.path.abspath(os.environ.get(
    'DBMS_EXCLUSIONS_DIR', os.path.join(os.path.dirname(HERE), 'exclusions')
)) + os.sep
...
def build():
    ...
    A('Every data item left out of the loaded database, with the reason. One '
      'entry per item.')
    A('')
    A('This file is generated by `normalization/exclusions.py`, which '
