...
Sector representatives exchange dependencies, progress and review findings};
...
\begin{table}[H]
\centering
\caption{Confirmed duties at each Scrum level}
...
2 & Cross-group coordination & Share sector progress, surface integration
dependencies and communicate review feedback between groups. \\
...
and the SQLite release are reviewed as connected work products. A change in
