...
\addplot+[cublue,thick,mark=none]
  table[x=year,y=value]{generated/annual_temperature.dat};
...
\addplot+[cuteal,thick,mark=none]
  table[x=year,y=value]{generated/annual_rainfall.dat};
\end{axis}
\end{tikzpicture}
...
\midrule
\inputrows{generated/rainfall_ranking.tex}
\bottomrule
\end{tabular}
\end{table}
...
\addplot table[x=records,y=parameter]
  {generated/water_quality_parameters.dat};
\end{axis}
\end{tikzpicture}
...
\texttt{River\_Station} and from there to a river. Climate tables can be
...
\midrule
\inputrows{generated/missing_measurements.tex}
\bottomrule
\end{tabular}
\end{table}

Missing values remain \texttt{NULL}; they are never replaced by zero. The most
important geographic limitation is separate from the measurement table:
