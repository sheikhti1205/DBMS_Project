...
REPORT = SCRIPT_DIR.parent
APPROVED_ERD = REPORT / "assets" / "Final_erd.png"
APPROVED_ERD_SHA256 = (
...
BENCHMARK = ROOT / "schema" / "scripts" / "competency" / "benchmark.json"
EXCLUSION_SUMMARY = ROOT / "normalization" / "exclusions" / "summary.json"
SOURCE_INVENTORY = SCRIPT_DIR / "source_inventory.json"
...
with (OUT / "measured.tex").open("w", encoding="utf-8") as handle:
    handle.write("% Generated by report/scripts/measure.py; do not edit manually.\n")
