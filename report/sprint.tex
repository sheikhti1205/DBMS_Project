...
files selected for processing. The other
...
\begin{description}[style=nextline]
  ...
  identifiers remain documented instead of being forced into processing.
...
structured processing directly. & Prefer machine-readable files; retain relevant
...
screening outcome identifies \mSourceFiles{} structured files selected for
processing and records excluded files and sheets separately. Section~\ref{sec:data}
