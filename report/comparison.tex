...
Current discovery/resource register (candidate entries) & 139 entries under 18
named source labels & 35 entries under 6 named source labels \\
...
Converted or extracted derivatives & 62 named extraction blocks from 9
structured files selected for processing; broader formatted outputs are kept
separate from original sources & 47 CSV files in the separate converted
collection \\
